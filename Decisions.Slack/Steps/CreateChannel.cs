...
public class CreateChannel : AbstractStep
{
    ...
    public override DataDescription[] InputData
    {
        get
        {
            ...
            {
                new DataDescription(typeof(string), channelLabel), new DataDescription(typeof(bool), isPrivateLabel),
            };
    ...
    public override OutcomeScenarioData[] OutcomeScenarios
    {
        get
        {
            var data = new OutcomeScenarioData[]
                { new OutcomeScenarioData(resultOutcomeLabel, new DataDescription(typeof(SlackChannel), resultLabel)) };
